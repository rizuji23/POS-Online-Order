...
<head>
    ...
    <title>Kelola Pemasukan Kredit | Imajinasi Management System</title>
    <!-- Favicon -->
...
<body>
                ...
                <div class="header-body">
                    <div class="row align-items-center py-4">
                        <div class="col-lg-6 col-7">
                            <h6 class="h2 text-white d-inline-block mb-0">Kelola Pemasukan</h6>
                ...
                <div class="col-xl-4 order-xl-2">
                    <div class="card card-profile">
                        ...
                        <div class="card-body pt-3">
                            ...
                            <a href="kelolapemasukan.php" class="btn btn-success btn-block">Kelola Debit</a>
                            <a href="kelolapemasukankredit.php" class="btn btn-success btn-block">Kelola Kredit</a>
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th scope="col" class="sort" data-sort="budget">Label Kredit</th>
                                        <th>Uang Keluar</th>
                                        <th>Tanggal</th>
                                ...
                                $debit = mysqli_query($koneksi, "SELECT * FROM kredit WHERE status = '1'");
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="budget">
                                        <?php echo $d['label_kredit'] ?>
                                    </td>
                                    <td>
                                        <?php echo $d['uang_keluar'] ?>
                                    </td>
                                    <td>
                                        <?php echo $d['tanggal'] ?>
                                    </td>
                                    ...
                                    <td class="text-right">
                                        <a href="edit.php?kre=<?php echo $d['id_kredit'] ?>" class="btn btn-sm btn-success">Edit</a>
                                        <a href="javascript:void(0)" onclick="detailKredit('<?php echo $d['id_kredit'] ?>')" class="btn btn-sm btn-info">Detail</a>
                                    </td>
    ...
    <div class="modal fade bd-example-modal-lg" id="detailKredit" tabindex="-1" role="dialog" aria-labelledby="detailKreditLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="detailKreditLabel">Detail Produk</h5>
