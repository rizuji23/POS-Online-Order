<?php 
  ...
  if (empty($_SESSION['username_admin']) || $_SESSION['level'] == "Management" || $_SESSION['level'] == "Keuangan" || $_SESSION['level'] == "Kasir" || $_SESSION['level'] == "Marketing"){
...
<body>
    ...
    <div class="main-content" id="panel">
                        ...
                        <div class="col-lg-6 col-7">
                            ...
                            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                    ...
                                    <li class="breadcrumb-item"><a href="kelolaproduk.php">Kelola Produk</a></li>
        ...
        <?php 
            ...
            $edit = mysqli_query($koneksi, "SELECT * FROM produk INNER JOIN kategori ON produk.kategori = kategori.id_kategori WHERE produk.status = '1' AND id_produk = '$id'");
                ...
                <div class="col-xl-4 order-xl-2">
                    <div class="card card-profile">
                        ...
                        <div class="card-body pt-3">
                            <h2>Menu</h2>
                            <a href="dataproduk.php" class="btn btn-primary btn-block">Tambah Produk</a>
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="pl-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_produk" value="<?php echo $e['nama_produk'] ?>" required class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-control-label">Deskripsi Pendek Produk
                                        </label>
                                        <input type="text" name="desk_produk" value="<?php echo $e['desk_produk'] ?>" required class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-control-label">Harga Produk</label>
                                        <input type="text" id="hargaproduk" value="<?php echo $e['harga'] ?>" name="harga" required class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-control-label">Volume Cup/Botol</label>
                                        <input type="text" name="vol" value="<?php echo $e['ml'] ?>" required class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-control-label">Tentang Produk</label>
                                        <textarea type="text"  name="tentang" rows="10" class="form-control"
                                            required><?php echo $e['tentang_produk'] ?></textarea>
                                    </div>
                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <div class="form-group">
                                       <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editFoto">Edit Foto</button>
                                    ...
                                    <div class="form-group">
                                        <label for="">Kategori</label>
                                           ...
                                           <select name="kategori" class="form-control" id="">
                                               <option value="<?php echo $e['id_kategori'] ?>"><?php echo $e['kategori'] ?> => <?php echo $e['jenis_kategori'] ?></option>
    ...
    <!-- Modal Secsion -->
    <div class="modal fade bd-example-modal-lg" id="editFoto" tabindex="-1" role="dialog" aria-labelledby="editFotoLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
            ...
            <div class="modal-body">
                ...
                if (isset($_POST['editfoto'])){
                    ...
                    $foto = mysqli_query($koneksi, "SELECT * FROM foto_produk WHERE id_produk = '$id' AND status = '1'");
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" name="editfoto">Edit</button>
            </div>
            </form>
            </div>
        </div>
