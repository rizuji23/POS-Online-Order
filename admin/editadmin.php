...
<head>
    ...
    <title>Edit Admin | Imajinasi Management System</title>
    <!-- Favicon -->
...
<body>
    ...
    <div class="main-content" id="panel">
                        ...
                        <div class="col-lg-6 col-7">
                            ...
                            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                    ...
                                    <li class="breadcrumb-item"><a href="kelolaadmin.php">Kelola Admin</a></li>
        ...
        <?php 
            ...
            $id = mysqli_escape_string($koneksi, $_GET['ad']);
            $edit = mysqli_query($koneksi, "SELECT * FROM admin WHERE status = '1' AND id_admin = '$id'");
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="pl-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_admin" value="<?php echo $e['nama_admin'] ?>" required class="form-control">
                                    </div>
                                    
                                    <div class="form-group">
                                        <label class="form-control-label">Email Admin</label>
                                        <input type="text" name="email_admin" value="<?php echo $e['email_admin'] ?>" required class="form-control">
                                    </div>


                                    <div class="form-group">
                                        <label class="form-control-label">Username</label>
                                        <input type="text" name="username" value="<?php echo $e['username'] ?>" required class="form-control">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="level" id="" class="form-control">
                                            ...
                                            <option value="Keungangan">Keungangan</option>
                                ...
                                <div class="form-group float-right">
                                    <button type="submit" name="edit_admin" class="btn btn-primary">Edit</button>
                                </div>
