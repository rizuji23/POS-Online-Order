<?php 
    ...
    if (empty($_SESSION['username_admin']) || $_SESSION['level'] == "Kasir" || $_SESSION['level'] == "Keuangan"){
...
<head>
    ...
    <title>Data User Membership | Imajinasi Management System</title>
    <!-- Favicon -->
...
<body>
                ...
                <div class="header-body">
                    <div class="row align-items-center py-4">
                        <div class="col-lg-6 col-7">
                            <h6 class="h2 text-white d-inline-block mb-0">Data User Membership</h6>
                            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                    <li class="breadcrumb-item"><a href="dashboard.php"><i class="fas fa-home"></i></a>
                                    </li>
                                    <li class="breadcrumb-item active">Data User Membership</li>
                                </ol>
                            </nav>
                        </div>
                ...
                <div class="col-xl-4 order-xl-2">
                    <div class="card card-profile">
                        ...
                        <div class="card-body pt-3">
                            ...
                            <a href="datauser.php" class="btn btn-primary btn-block">Data Users</a>
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody class="list" id="datauserm">
                                    
                                    <img src="assets/img/loading.gif" class="img-fluid" id="loading" alt="">
    ...
    <div class="modal fade bd-example-modal-lg" id="detailUsers" tabindex="-1" role="dialog" aria-labelledby="detailUsersLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="detailUsersLabel">Detail User</h5>
