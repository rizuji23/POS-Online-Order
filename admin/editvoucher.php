...
<head>
    ...
    <title>Edit Voucher | Imajinasi Management System</title>
    <!-- Favicon -->
...
<body>
    ...
    <div class="main-content" id="panel">
                ...
                <div class="header-body">
                    <div class="row align-items-center py-4">
                        <div class="col-lg-6 col-7">
                            <h6 class="h2 text-white d-inline-block mb-0">Edit Voucher</h6>
                            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                    <li class="breadcrumb-item"><a href="#"><i class="fas fa-home"></i></a></li>
                                    <li class="breadcrumb-item"><a href="pengaturan.php">Pengaturan</a></li>
                                    <li class="breadcrumb-item"><a href="kelolavoucher.php">Kelola Voucher</a></li>
        ...
        <?php 
            ...
            $id = mysqli_escape_string($koneksi, $_GET['voc']);
            $edit = mysqli_query($koneksi, "SELECT * FROM voucher WHERE status = '1' AND id_voucher = '$id'");

            $e = mysqli_fetch_assoc($edit);

            if (isset($_POST['edit_voucher'])){
                edit_voucher($_POST, $id);
            }
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="pl-lg-4">
                                    <div class="form-group">
                                        <label class="form-control-label">Kode Voucher</label>
                                        <input type="text" name="kode_voucher" value="<?php echo $e['kode_voucher'] ?>" required class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-control-label" for="input-username">Percent Potongan</label>
                                        <input type="number" name="percent" value="<?php echo $e['percent'] ?>" required class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-control-label">Jenis Kategori
                                        </label>
                                        <select name="jenis_voucher" class="form-control" id="">
                                               <option value="<?php echo $e['jenis_voucher'] ?>"><?php echo $e['jenis_voucher'] ?></option>
                                ...
                                <div class="form-group float-right">
                                    <button type="submit" name="edit_voucher" class="btn btn-primary">Edit</button>
                                </div>
