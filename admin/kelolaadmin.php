...
<head>
    ...
    <title>Kelola Admin | Imajinasi Management System</title>
    <!-- Favicon -->
                ...
                <div class="header-body">
                    <div class="row align-items-center py-4">
                        <div class="col-lg-6 col-7">
                            <h6 class="h2 text-white d-inline-block mb-0">Kelola Admin</h6>
                            ...
                            <table class="table align-items-center table-flush">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th scope="col" class="sort" data-sort="budget">ID Admin</th>
                                        <th scope="col" class="sort" data-sort="status">Nama Admin</th>
                                ...
                                <tbody class="list">
                                   <?php 
                                    ...
                                    $data_kategori = mysqli_query($koneksi, "SELECT * FROM admin WHERE status = '1'");
                                    $no = 1;
                                ...
                                <tr>
                                        ...
                                        <td class="budget">
                                            <?php echo $dk['id_admin'] ?>
                                        </td>
                                        <td>
                                            <?php echo $dk['nama_admin'] ?>
                                        </td>
                                        <td>
                                            <?php echo $dk['email_admin'] ?>
                                        </td>
                                        <td>
                                            <?php echo $dk['username'] ?>
                                        </td>
                                        ...
                                        <td class="text-right">
                                            <a href="hapus.php?ad=<?php echo $dk['id_admin'] ?>" class="btn btn-sm btn-danger">Hapus</a>
                                            <a href="editadmin.php?ad=<?php echo $dk['id_admin'] ?>" class="btn btn-sm btn-success">Edit</a>
                                        </td>
