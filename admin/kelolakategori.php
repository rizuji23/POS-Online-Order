...
<head>
    ...
    <title>Kelola Kategori | Imajinasi Management System</title>
    <!-- Favicon -->
                            ...
                            <table class="table align-items-center table-flush">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th scope="col" class="sort" data-sort="budget">ID Kategori</th>
                                ...
                                <tbody class="list">
                                   <?php 
                                    ...
                                    $data_kategori = mysqli_query($koneksi, "SELECT * FROM kategori WHERE status = '1'");
                                    $no = 1;
                                ...
                                <tr>
                                        ...
                                        <td class="budget">
                                            <?php echo $dk['id_kategori'] ?>
                                        </td>
                                        <td>
                                            <?php echo $dk['kategori'] ?>
                                        </td>
                                        <td>
                                            <?php echo $dk['jenis_kategori'] ?>
                                        </td>
                                        <td class="text-right">
                                            <a href="hapus.php?kat=<?php echo $dk['id_kategori'] ?>" class="btn btn-sm btn-danger">Hapus</a>
                                            <a href="editkategori.php?kat=<?php echo $dk['id_kategori'] ?>" class="btn btn-sm btn-success">Edit</a>
                                        </td>
