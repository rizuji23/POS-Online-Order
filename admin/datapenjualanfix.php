...
<head>
    ...
    <title>Data Penjualan Fix | Imajinasi Management System</title>
    <!-- Favicon -->
                ...
                <div class="col-xl-8 order-xl-1">
                    <div class="card">
                        ...
                        <div class="card-header border-0">
                            <h3 class="mb-0">Data Penjualan Fix</h3>
                        </div>
                        <!-- Light table -->
                            ...
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody class="list">
                                    <?php 
                                        ...
                                        $data_penjualan = mysqli_query($koneksi, "SELECT  pf.id_pemesanan_front, pf.id_user, pf.total, pf.tanggal_update, pf.status, u.id_user, u.nama_lengkap FROM pemesanan_front pf INNER JOIN users u ON pf.id_user = u.id_user WHERE pf.status = '3' ORDER BY id_pemesanan_front DESC");
