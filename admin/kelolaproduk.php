...
<head>
    ...
    <title>Kelola Produk | Imajinasi Management System</title>
    <!-- Favicon -->
                        ...
                        <div class="col-lg-6 col-7">
                            ...
                            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                    ...
                                    <li class="breadcrumb-item"><a href="dataproduk.php">Data Produk</a></li>
                            ...
                            <table class="table align-items-center table-flush">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th scope="col" class="sort" data-sort="status">Nama Produk</th>
                                        <th scope="col">Harga Produk</th>

                                        <th scope="col">Option</th>
                                    </tr>
                                </thead>
                                <tbody class="list" id="dataproduk">
