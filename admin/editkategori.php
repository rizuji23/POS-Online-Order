...
<head>
    ...
    <title>Edit Kategori | Imajinasi Management System</title>
    <!-- Favicon -->
...
<body>
    ...
    <div class="main-content" id="panel">
                ...
                <div class="header-body">
                    <div class="row align-items-center py-4">
                        <div class="col-lg-6 col-7">
                            <h6 class="h2 text-white d-inline-block mb-0">Edit Kategori</h6>
                            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                    <li class="breadcrumb-item"><a href="#"><i class="fas fa-home"></i></a></li>
                                    <li class="breadcrumb-item"><a href="pengaturan.php">Pengaturan</a></li>
                                    <li class="breadcrumb-item"><a href="kelolakategori.php">Kelola Kategori</a></li>
        ...
        <?php 
            ...
            $id = mysqli_escape_string($koneksi, $_GET['kat']);
            $edit = mysqli_query($koneksi, "SELECT * FROM kategori WHERE status = '1' AND id_kategori = '$id'");

            $e = mysqli_fetch_assoc($edit);

            if (isset($_POST['edit_kategori'])){
                edit_kategori($_POST, $id);
            }
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" enctype="multipart/form-data">
                                <h6 class="heading-small text-muted mb-4">Identitas Kategori</h6>
                                <div class="pl-lg-4">
                                    <div class="form-group">
                                        <label class="form-control-label">Kategori</label>
                                        <input type="text" name="kategori" value="<?php echo $e['kategori'] ?>" required class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-control-label">Jenis Kategori
                                        </label>
                                        <select name="jenis_kategori" class="form-control" id="">
                                               <option value="<?php echo $e['jenis_kategori'] ?>"><?php echo $e['jenis_kategori'] ?></option>
