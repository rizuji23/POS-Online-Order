...
<head>
  ...
  <title>Dashboard | Imajinasi Management System</title>
  <!-- Favicon -->
    ...
    <div class="header bg-primary pb-6">
      <div class="container-fluid">
        <div class="header-body">
          ...
          $user_t = mysqli_query($koneksi, "SELECT * FROM users");
          
          $ut = mysqli_num_rows($user_t);

          $penjualan = mysqli_query($koneksi, "SELECT SUM(qty) AS q FROM pemesanan INNER JOIN pemesanan_front ON pemesanan.id_pemesanan_f = pemesanan_front.id_pemesanan_front WHERE pemesanan_front.status = '3'");
          $pen = mysqli_fetch_assoc($penjualan);

          $pemesanan = mysqli_query($koneksi, "SELECT * FROM pemesanan_front WHERE status = '3'");
          $peme = mysqli_num_rows($pemesanan);
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0"><?php echo $p; ?></span>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0"><?php echo $ut; ?></span>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Total Penjualan Cup/Produk</h5>
                      <span class="h2 font-weight-bold mb-0"><?php echo $pen['q']; ?></span>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Total Pemesanan</h5>
                      <span class="h2 font-weight-bold mb-0"><?php echo $peme; ?></span>
                    </div>
                    <div class="col-auto">
          ...
          <div class="col-lg-6">
            <div class="copyright text-center text-xl-left text-muted">
              &copy; 2021 Template by <a href="https://www.creative-tim.com" class="font-weight-bold ml-1"
                ...
                Tim</a> and Development by <a href="https://www.instagram.com/rizuji23" class="font-weight-bold ml-1"
                target="_blank">Rizki Fauzi</a>
            </div>
          </div>
