...
<head>
    ...
    <title>Kelola Pemasukan Debit | Imajinasi Management System</title>
    <!-- Favicon -->
...
<body>
                            ...
                            <table class="table align-items-center table-flush">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th scope="col" class="sort" data-sort="budget">Label Debit</th>
                                        <th>Uang Masuk</th>
                                        <th>Tanggal</th>
                                ...
                                <?php 
                                    ...
                                    $debit = mysqli_query($koneksi, "SELECT * FROM debit WHERE status = '1'");
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="budget">
                                            <?php echo $d['label_debit'] ?>
                                        </td>
                                        <td>
                                            <?php echo $d['uang_masuk'] ?>
                                        </td>
                                        <td>
                                            <?php echo $d['tanggal'] ?>
                                        </td>
                                        ...
                                        <td class="text-right">
                                            <a href="edit.php?deb=<?php echo $d['id_debit'] ?>" class="btn btn-sm btn-success">Edit</a>
                                            <a href="javascript:void(0)" onclick="detailDebit('<?php echo $d['id_debit'] ?>')" class="btn btn-sm btn-info">Detail</a>
                                        </td>
    ...
    <div class="modal fade bd-example-modal-lg" id="detailDebit" tabindex="-1" role="dialog" aria-labelledby="detailDebitLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="detailDebitLabel">Detail Produk</h5>
