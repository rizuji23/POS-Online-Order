...
<head>
    ...
    <title>Data User Tamu | Imajinasi Management System</title>
    <!-- Favicon -->
                ...
                <div class="header-body">
                    <div class="row align-items-center py-4">
                        <div class="col-lg-6 col-7">
                            <h6 class="h2 text-white d-inline-block mb-0">Data User Tamu</h6>
                            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                    <li class="breadcrumb-item"><a href="dashboard.php"><i class="fas fa-home"></i></a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="datauser.php">Data User Tamu</a>
                                    </li>
                ...
                <div class="col-xl-4 order-xl-2">
                    <div class="card card-profile">
                        ...
                        <div class="card-body pt-3">
                            ...
                            <a href="datauser.php" class="btn btn-primary btn-block">Data User Membership</a>
                            <a href="datausert.php" class="btn btn-success btn-block">Data User Tamu</a>
                ...
                <div class="col-xl-8 order-xl-1">
                    <div class="card">
                        ...
                        <div class="card-header border-0">
                            <h3 class="mb-0">Data User Tamu</h3>
                        </div>
                        <!-- Light table -->
                            ...
                            <table class="table align-items-center table-flush">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th scope="col" class="sort" data-sort="budget">IP User</th>
                                       
                                        <th scope="col">Option</th>
                                    </tr>
                                </thead>
                                <tbody class="list" id="datausert">
